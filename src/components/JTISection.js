        ...
        return (
          <div className="wrapsection">
              <section className={"container"}>
                  <div className={"toto_bene_img " + this.props.addClass} id={this.props._id} style={style} >
                  </div>
                  <div className="intro">
                      <div className={"intro_title "+ this.props.couleur}>
                  ...
                  <div className="pieces">
                      <div className={"pieces_title "+ this.props.couleur}>
                      ...
                      <div className="pieces_imgs">
                          <div className="pics_grid">
                              ...
                              <div className="comment _1"><h2 className={this.props.couleur}>{this.props.comments[0]}</h2></div>
                              ...
                              <div className="comment _2"><h2 className={this.props.couleur}>{this.props.comments[1]}</h2></div>
                              <div className={"pic _4"} style={{"backgroundImage": `url(${this.props.imgs[3]})`}} alt=""></div>
                              <div className="comment _3"><h2 className={this.props.couleur}>{this.props.comments[2]}</h2></div>
